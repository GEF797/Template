...
public:
	/*
	 * This is a new optional experimental feature.
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = OptionalTraceManagerComponentSettings, meta = (DisplayName = "Use External Trace Manager Component ?"))
	bool use_trace_manager_component = false;


	/*
	 * Only relevant if using the optional "DragonIK Trace Manager component".
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = OptionalTraceManagerComponentSettings, meta = (DisplayName = "Unique Solver Identifier"))
	int solver_identifier = 1;
...
*/
   UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InputData, meta = (PinHiddenByDefault,EditCondition = "!use_type2_input"))
	...
	/*
	 * If you have a more "complicated" skeleton on your character, you can make use of the second input method which gives you more control.
...
//		float MinimumRoll = -45;
	...
	*/
	...
	UPROPERTY()
	TObjectPtr<UDragonIKTraceManagerComponent> Dragon_Trace_Manager = nullptr;
...
*/
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = LegStabilization, meta = (ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0", DisplayName = "(Downslope) Pelvic legs stabilization alpha", PinHiddenByDefault))
		float Pelvis_DownSlopeStabilization_Alpha = 0.5f;
...
*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SnakeSettings, meta = (DisplayName = "Hold Root Bone In Place For Snake IK", PinHiddenByDefault))
		bool Hold_Snake_Root_Bone = false;
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SnakeSettings, meta = (DisplayName = "Is custom fixed bone heights for snakeIK ?", PinHiddenByDefault))
		bool use_custom_fixed_bone_height = false;


	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SnakeSettings, meta = (EditCondition = "use_custom_fixed_bone_height",DisplayName = "Custom Fixed Bone Height", PinHiddenByDefault))
		FDragonData_SnakeCustomHeight_Struct custom_fixed_bone_height = FDragonData_SnakeCustomHeight_Struct();
...
*/
	...
	*/
	...
	float Normalize_Towards_Up_Axis(FVector Input_Vector);
...
//	void Dragon_SingleImpactRotationv2(int origin_point_index, FTransform &OutputTransform, FCSPose<FCompactPose>& MeshBases, bool is_reverse);
	...
	UPROPERTY()
	TObjectPtr<AActor> Character_Actor = nullptr;

	UPROPERTY()
	USkeleton* skeleton_ref = nullptr;
	...
	FTransform owner_skel_w_unrotated_transform = FTransform::Identity;
...
protected:
	...
	float UpVectorNormalized_HeightCheck(FVector vectorA,FVector vectorB);

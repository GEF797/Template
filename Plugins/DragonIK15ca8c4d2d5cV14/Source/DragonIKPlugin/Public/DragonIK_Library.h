...
enum class EInput_FatBoneFAxis : uint8
{
	...
	ENUM_XAxis UMETA(DisplayName = "X-Axis"),
	ENUM_YAxis 	UMETA(DisplayName = "Y-Axis"),
	ENUM_ZAxis 	UMETA(DisplayName = "Z-Axis"),
	ENUM_XYZAxis 	UMETA(DisplayName = "XYZ")
...
struct FDragonData_StickyFeetStruct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Sticky Feet Array", PinVisibleByDefault))
	 TArray<bool> sticky_feet_array;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Sticky Feet Alpha Array", PinVisibleByDefault))
...
struct FDragonData_FeetAlpha_Struct
{
	GENERATED_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet IK Alpha", PinVisibleByDefault))
...
struct FDragonData_SnakeCustomHeight_Struct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Snake Bone Heights", PinVisibleByDefault))
		TArray<float> snake_bone_height_array;
...
struct FDragonData_ElbowOffset_Struct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet Extra Offset Array", PinVisibleByDefault))
...
struct FDragonData_StickySocketStruct
{
	GENERATED_BODY()
		...
		UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Sticky Socket Array", PinVisibleByDefault))
...
struct FDragonData_ArmSizeStruct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Use Custom Arm Sizes ?", PinVisibleByDefault))
	 bool Use_Custom_Arm_Sizes = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Upper Arm Length", PinVisibleByDefault))
	 float custom_upperArm_length = 0;


	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Lower Arm Length", PinVisibleByDefault))
...
struct FDragonData_CustomArmLengths
{
	GENERATED_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Arm Length Data", PinVisibleByDefault))
...
struct FDragonData_CustomLimbClamp
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Per-Limb Clamp Array", PinVisibleByDefault))
...
struct FDragonData_BoneStruct
{
	...
	TArray<FBoneReference> SecondKneeBones;
...
public :
	...
	bool should_shoulder_twist_if_inward = false;


	bool clavicle_only_bend_if_limit = false;
...
struct FDragonData_SpineFeetPair
{
	...
	TArray<FBoneReference> Spine_Children_Involved;
...
//	TArray<float> Feet_Slope_Offset_Multiplier;
	...
	TArray<TArray<FBoneReference>> Feet_Follow_Bones_Array;
...
struct FDragonData_WarpLimbsData
{
	...
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (PinVisibleByDefault))
	...
	*/
	...
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Minimum Maximum Warp" , PinVisibleByDefault))
...
struct FDragonData_SingleArmElement
{
	GENERATED_BODY()
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Arm Target Transform", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Alpha", PinVisibleByDefault))
		float Arm_Alpha = 1;
...
* This scales the finger line trace relative to the size of the foot trace heights.
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Hand Rotation Offset", PinVisibleByDefault))
...
struct FDragonData_Overrided_Location_Data
{
	GENERATED_BODY()
		...
		*/
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Separate Arm Target Array Override", PinVisibleByDefault))
...
struct FDragonData_ArmsData
{
	GENERATED_BODY()
		...
		*/
		UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Clavicle Bone (optional)", PinVisibleByDefault))
...
*/
	...
	*/
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Is this right hand ?", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Invert lower arm twist ?", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Invert upper arm twist ?", PinVisibleByDefault))
	...
	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Twist Forearm Bone (optional)", PinVisibleByDefault))
		FBoneReference Twist_Forearm_Bone;


	UPROPERTY(EditAnywhere, Category = SkeletalControl, meta = (DisplayName = "Twist Shoulder Bone (optional)", PinVisibleByDefault))
		FBoneReference Twist_Shoulder_Bone;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Local Hand Axis (If accurate hand rotation)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (PinVisibleByDefault))
...
//		bool Use_NSEW_Poles = false;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Elbow Pole Offset (SINGLE POLE METHOD)", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "North Pole (NSEW POLE METHOD)", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "South Pole (NSEW POLE METHOD)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "West Pole (NSEW POLE METHOD)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "East Pole (NSEW POLE METHOD)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Overrided clamp limits ?", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Overrided (Horizontal Clamp)", PinVisibleByDefault))
...
* Only used if overrided limits is used.
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Overrided (Vertical Clamp)", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Clavicle Inner Rotation limit (Sideways)", PinVisibleByDefault))
...
* Negative value comes for Y.
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Clavicle Inner Rotation limit (Vertical)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Clavicle Total Rotation limit (Sideways)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Clavicle Total Rotation limit (Vertical)", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Shoulder Inner Twist limit", PinVisibleByDefault))
...
*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Shoulder Outer Twist limit", PinVisibleByDefault))
...
*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Forearm Outer Twist limit", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Twist Offset when hand is directly towards arm", PinVisibleByDefault))
		float Twist_Offset_Reverse = 180;



/*
 * Enable this to let the shoulder twist even if the arm is bending inwards. This is disabled to get natural feeling poses as usually shoulders dont twist all that much.
 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Should shoulder twist if arm is bending inwards ?", PinVisibleByDefault))
	 bool should_shoulder_twist_if_inward = false;


	/*
	 * Enable this to let the clavicle rotation only start bending if the arm exceeds its reaching limit.
	 * If enabled, the inner clamp parameters of the clavicle is completely ignored.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Should clavicle rotation be a part of natural arm extension ?", PinVisibleByDefault))
	bool clavicle_part_of_extension = true;
...
* This scales the finger line trace relative to the size of the foot trace heights.
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Trace size scale", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Is finger pointing backwards ?", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "(optional) Second Knee Bone",PinVisibleByDefault))
	FName Second_Knee_Bone_Name = "None";
	...
	float Knee1_Knee2_Bend_Ratio = 1;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Fixed Pole ?",PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Knee Pole Offset",PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Frontal spacing (4-point feets)",PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Side spacing (4-point feets)", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Minimum Feet extension ratio", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Maximum Feet extension ratio", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet Extra Up-Slope Offset Multiplier", PinVisibleByDefault))
	...
	/*
		...
		* Use small values like 0.1f, because this is a multiplier which increases/decreases the lift depending on the pitch/roll difference of the feet as it touches steep slopes.
		*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet Extra Down-Slope Offset Multiplier", PinVisibleByDefault))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet Slope Multiplier Clamp Radius", PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Max Feet Lift Height in UP Axis", PinVisibleByDefault))
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Overrided trace radius (if capsule trace used)", PinVisibleByDefault))
		float Overrided_Trace_Radius = 0.0f;



	/*
	 * The bones listed here will move and rotate with the feet bone's transform when performing the foot placement process.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Feet Follow Bones (optional)",  PinVisibleByDefault))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Finger Array (optional)",  PinVisibleByDefault))
...
public:
		...
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Start Spine / Chest",PinVisibleByDefault))
		FName Start_Spine;
...
struct FDragonData_FootPairData
{
	...
	/*
	 * The first common bone within the spine the pair of legs connect to.
	...
	/*
	 * If you want certain bones to follow the changes of the "Common Spine Bone", add them here.
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "(optional) Child Follow Bones",PinVisibleByDefault))
...
public:
	...
	/*
	 * The complete spine structure of the character. From the pelvis to the chest.
	 * Index 0 of this array should be the "pelvis" or the "tail root" bone of your skeleton and the last index should be the "tail tip".
	 * You can have any number of bones here.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Tail Chain Heights", PinVisibleByDefault))
...
public:
	 ...
	 * You can have any number of bones here.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Bone Structure", PinVisibleByDefault))
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Bone Name", PinVisibleByDefault))
		FName Bone_Name;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Bone Axis", PinVisibleByDefault))
		EInput_FatBoneFAxis Bone_Axis = EInput_FatBoneFAxis::ENUM_XYZAxis;


		FBoneReference Bone_Ref;
...
public:
	...
	/*
	 * The complete spine structure of the character. From the pelvis to the chest.
	 * Index 0 of this array should be the "pelvis" bone of your skeleton and the last index should be the "chest" or "head" bone.
	 * You can have any number of bones here.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Bone Structure", PinVisibleByDefault))
		TArray<FDragonData_BoneFatStruct> Custom_Bone_Structure;
...
public:
	 ...
	 * You can have any number of bones here.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Fat Control Strength Array", PinVisibleByDefault))
	TArray<float> FatControlStrengthArray;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Custom Bone Rotation Offset", PinVisibleByDefault))
...
public:
	 ...
	 * You can have any number of bones here.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SkeletalControl, meta = (DisplayName = "Spine Skeleton Structure",PinVisibleByDefault))
	 TArray<FName> Spine_Structure;
	

	/*
	 * Define the spine-feet pairing data here. Order is important.
...
public:
	...
	* They have a zero length distance, so they will inherit this bone's transformation. */
	...
	FCCDIK_Modified_ChainLink()
		: Position(FVector::ZeroVector)
		, solverLocalPositions(FVector::ZeroVector)
		, BoneRotation(FQuat::Identity)
		, Length(0.f)
...
public :
	...
	static void EstablishParentChildRelationship(FTransform& Transform1, const FTransform& InitialTransform1, FTransform& Transform2, const FTransform& InitialTransform2);
...
//	static void Solve_Modified_TwoBoneIK(const FVector& RootPos, const FVector& JointPos, const FVector& EndPos, const FVector& JointTarget, const FVector& Effector, FVector& OutJointPos, FVector& OutEndPos, float UpperLimbLength, float LowerLimbLength, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale);
	...
	static void RectifyNaNRotator(FRotator& Rotator);

	static bool TraceSelectorFire(UDragonIKTraceManagerComponent* TraceComponent,UObject* WorldContextObject,FVector  startpoint,FVector  endpoint, float trace_radius, bool is_line,  ETraceTypeQuery TraceChannel, bool bTraceComplex, const TArray<AActor*>& ActorsToIgnore, EDrawDebugTrace::Type DrawDebugType, FHitResult& OutHit,  bool bIgnoreSelf, FLinearColor TraceColor,FName unique_identifier,FName bone_text);
